...
int grpci2_loopback_test(unsigned int base_addr, unsigned int conf_addr, unsigned int apb_addr, 
  ...
  pcimem = (volatile unsigned int*)(base_addr | (((int)ahbmem) &~ base_addr_mask));
  ...
  if (grpci2_get_dma(apb)){
    ...
    ddesc1->paddr = pci_addr | ((unsigned int)(ahbmem + 32) &~ pci_addr_mask);
    ...
    ddesc2->paddr = pci_addr | ((unsigned int)(ahbmem + 32) &~ pci_addr_mask);
    ...
    ddesc3->paddr = pci_addr | ((unsigned int)(ahbmem + 96) &~ pci_addr_mask);
