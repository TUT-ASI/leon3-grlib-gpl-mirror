 ...
 *
 */
int griommu_flush_start(addr_t addr)
{
 ...
 *
 */
int griommu_flush_wait(addr_t addr)
{
    unsigned int tmp;
    struct griommu_reg *r = (struct griommu_reg *) addr;
 ...
 *
 */
void griommu_derrinj(addr_t addr, unsigned int line)
{
    unsigned int tmp;
    struct griommu_reg *r = (struct griommu_reg *) addr;
 ...
 *
 */
void griommu_terrinj(addr_t addr, unsigned int line)
{
    unsigned int tmp;
    struct griommu_reg *r = (struct griommu_reg *) addr;
 ...
 *
 */
void griommu_passthrough(addr_t addr)
{
 ...
 *
 */
void griommu_deny_all(addr_t addr)
{
    unsigned char i, ngrp, nmst;
    struct griommu_reg *r = (struct griommu_reg *) addr;
 ...
 *
 */
static void griommu_reg_test(addr_t addr)
{
 ...
 *
 */
static void griommu_diag_test(addr_t addr)
{
 ...
 *
 */
static void griommu_ft_test(addr_t addr)
{
