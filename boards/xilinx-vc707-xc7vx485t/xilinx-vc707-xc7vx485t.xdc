...
set_property PACKAGE_PIN AY30 [get_ports {switch[4]}]
...
create_clock -period 8.000 -name gtrefclk [get_pins eth0.sgmii0/ibufds_gtrefclk/O]
...
set_max_delay -from [get_clocks -include_generated_clocks clk_pll_i]    -to [get_clocks {gtrefclk rxoutclk}] 8
set_max_delay -from [get_clocks -include_generated_clocks clk_pll_i]    -to [get_clocks -include_generated_clocks txoutclk] 8
set_max_delay -from [get_clocks gtrefclk ]                              -to [get_clocks -include_generated_clocks clk_pll_i] 8
set_max_delay -from [get_clocks -include_generated_clocks txoutclk]     -to [get_clocks -include_generated_clocks clk_pll_i] 8
set_max_delay -from [get_clocks rxoutclk ]                              -to [get_clocks -include_generated_clocks clk_pll_i] 8
...
set_max_delay -from [get_clocks gtrefclk ]                              -to [get_clocks {txoutclk rxoutclk}] 8
set_max_delay -from [get_clocks -include_generated_clocks txoutclk]     -to [get_clocks {gtrefclk rxoutclk}] 8
set_max_delay -from [get_clocks rxoutclk ]                              -to [get_clocks {gtrefclk}] 8
set_max_delay -from [get_clocks rxoutclk ]                              -to [get_clocks -include_generated_clocks txoutclk] 8

set_max_delay -from [get_clocks -include_generated_clocks *CLKOUT*]     -to [get_clocks -include_generated_clocks] 8
set_max_delay -from [get_clocks -include_generated_clocks]              -to [get_clocks -include_generated_clocks *CLKOUT*] 8
...
set_property PACKAGE_PIN AF35 [get_ports {can_rxd}]
set_property PACKAGE_PIN AF36 [get_ports {can_txd}]

set_property IOSTANDARD LVCMOS18 [get_ports can_rxd]
set_property IOSTANDARD LVCMOS18 [get_ports can_txd]
