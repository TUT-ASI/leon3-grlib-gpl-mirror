...
create_clock -period 16.000 -name txoutclk [get_pins eth0.sgmii0/core_wrapper/*trans*/gtwizard*/GTWIZ*/gt0*/gtx*/TXOUTCLK]
set_propagated_clock [get_clocks txoutclk]

# Clock period for the recovered Rx clock
create_clock -period 8.000 -name rxoutclk [get_pins eth0.sgmii0/core_wrapper/*trans*/gtwizard*/GTWIZ*/gt0*/gtx*/RXOUTCLK]
...
set_false_path -from [get_clocks gtrefclk ] -to [get_clocks -include_generated_clocks clk_pll_i]
set_false_path -from [get_clocks txoutclk ] -to [get_clocks -include_generated_clocks clk_pll_i]
set_false_path -from [get_clocks rxoutclk ] -to [get_clocks -include_generated_clocks clk_pll_i]

set_false_path -from  [get_clocks -include_generated_clocks clk_pll_i] -to [get_clocks gtrefclk]
set_false_path -from  [get_clocks -include_generated_clocks clk_pll_i] -to [get_clocks txoutclk]
set_false_path -from  [get_clocks -include_generated_clocks clk_pll_i] -to [get_clocks rxoutclk]

set_false_path -from [get_clocks gtrefclk ] -to [get_clocks {txoutclk rxoutclk}]
set_false_path -from [get_clocks txoutclk ] -to [get_clocks {gtrefclk rxoutclk}]
set_false_path -from [get_clocks rxoutclk ] -to [get_clocks {gtrefclk txoutclk}]

set_false_path -from [get_clocks -include_generated_clocks *CLKOUT*]  -to [get_clocks -include_generated_clocks]
set_false_path -from [get_clocks -include_generated_clocks]  -to [get_clocks -include_generated_clocks *CLKOUT*]
