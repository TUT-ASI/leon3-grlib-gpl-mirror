...
set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { ck_a[0] }]; #IO_0_35           	Sch=ck_a[0]		ChipKit pin=A0
set_property -dict { PACKAGE_PIN D8    IOSTANDARD LVCMOS33 } [get_ports { ck_a[1] }]; #IO_L4P_T0_35      	Sch=ck_a[1]		ChipKit pin=A1
set_property -dict { PACKAGE_PIN C7    IOSTANDARD LVCMOS33 } [get_ports { ck_a[2] }]; #IO_L4N_T0_35      	Sch=ck_a[2]		ChipKit pin=A2
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { ck_a[3] }]; #IO_L6P_T0_35      	Sch=ck_a[3]		ChipKit pin=A3
set_property -dict { PACKAGE_PIN D7    IOSTANDARD LVCMOS33 } [get_ports { ck_a[4] }]; #IO_L6N_T0_VREF_35 	Sch=ck_a[4]		ChipKit pin=A4
set_property -dict { PACKAGE_PIN D5    IOSTANDARD LVCMOS33 } [get_ports { ck_a[5] }]; #IO_L11P_T1_SRCC_35	Sch=ck_a[5]		ChipKit pin=A5
