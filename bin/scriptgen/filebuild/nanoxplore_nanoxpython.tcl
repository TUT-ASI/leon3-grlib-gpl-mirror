...
proc create_nanoxplore_nanoxpython {} {
    ...
    append vp "\nproject.load('$TOP\_native.nxm')"

    append vp "\nif not project.synthesize():"
    append vp "\n    sys.exit(1)"
    append vp "\nproject.save('$TOP\_synthesized.nxm')"
    append vp "\n"
    append vp "\nif not project.place():"
    append vp "\n    sys.exit(1)"
    append vp "\nproject.save('$TOP\_placed.nxm')"
    append vp "\n"
    append vp "\nif not path.exists(dir + '/$TOP\_pads.py'):"
    append vp "\n    project.savePorts('$TOP\_generated_pads.py')"
    append vp "\n"
    append vp "\nif not project.route():"
    append vp "\n    sys.exit(1)"
    append vp "\nproject.save('$TOP\_routed.nxm')"
    append vp "\n"
