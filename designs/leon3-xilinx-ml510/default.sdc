...
# Clocks
#
define_clock            -name {user_clksys}  -freq 130.000 -route 1.0 -clockgroup default_clkgroup
define_clock            -name {pci_p_clk5}  -freq 33.000 -clockgroup pci_clkgroup -route 6
define_clock            -name {phy0_txclk}  -freq 25.000 -clockgroup phy_tx_clkgroup -route 10.000
...
define_clock            -name {phy0_rxclk}  -freq 125.000 -clockgroup phy_rx_clkgroup -route 2.000
...
define_output_delay      -default  19.00 -improve 0.00 -route 3.00 -ref {pci_p_clk5:r}
define_input_delay       -default  23.00 -improve 0.00 -route 2.00 -ref {pci_p_clk5:r}
