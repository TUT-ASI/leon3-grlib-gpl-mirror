...
-- Technology and synthesis options
  constant CFG_FABTECH : integer := versal;       -- Must be versal ! (AHBJTAG)
  constant CFG_MEMTECH : integer := versal;
  constant CFG_PADTECH : integer := versal;
  constant CFG_TRANSTECH : integer := TT_XGTP0;
  constant CFG_NOASYNC : integer := 0;
  constant CFG_SCAN : integer := 0;
-- Clock generator
  constant CFG_CLKTECH : integer := versal;
