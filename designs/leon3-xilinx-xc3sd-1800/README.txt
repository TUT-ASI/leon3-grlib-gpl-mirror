...
Synplify version 9.4 is preferred for synthesis, since earlier versions
...
* When performing synthesis with the ISE suite it may be difficult to meet
  all timing constraints. To help the tools, there are placement constraints
  for the design's DCMs and BUFGMUX:es in the files leon3mp.xcf and 
  $GRLIB_ROOT/boards/xilinx-spa3-dsp1800a/leon3mp.ucf that can be used
  when synthesizing with XST. When using Synplify for synthesis the 
  constraints in the .ucf file should be commented out.
...
03.01:011   Gaisler Research  Modular Timer Unit (ver 0x0)
             ...
             8-bit scaler, 2 * 32-bit timers, divisor 38
...
grlib> load /tmp/128MiB
loading binary file to address 0x40000000
total size: 134217728 bytes (50.0 Mbit/s)
grlib> verify /tmp/128MiB
loading binary file to address 0x40000000
total size: 134217728 bytes (50.5 Mbit/s)
grlib>  
