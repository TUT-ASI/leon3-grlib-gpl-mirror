...
#if defined CONFIG_GRDMAC2ACC0
#define CONFIG_GRDMAC2ACC 0
#elif defined CONFIG_GRDMAC2ACC1
#define CONFIG_GRDMAC2ACC 1
#elif defined CONFIG_GRDMAC2ACC2
#define CONFIG_GRDMAC2ACC 2
#elif defined CONFIG_GRDMAC2ACC3
#define CONFIG_GRDMAC2ACC 3
#else
#define CONFIG_GRDMAC2ACC 0
#endif
